...
include "config.php";
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE `shop_clients` SET `firstname`='$firstname',`surname`='$surname',`email`='$email',`password`='$password' WHERE `id`='$user_id'"; 
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `shop_clients` WHERE `id`='$user_id'";
    ...
    ?>
        ...
        <form action="" method="post">
            ...
            <div class = firstn > First name:<br> <div>

            <input div class = fname type="text" name="firstname" value="<?php echo $first_name; ?>">

            <input type="hidden" name="user_id" value="<?php echo $id; ?>">

            <br>

            <div class = firstn > Surname:<br> <div>

            <input div class = sname type="text" name="surname" value="<?php echo $surname; ?>">

            <br>

            <div class = firstn > Email:<br> <div>

            <input div class = email type="email" name="email" value="<?php echo $email; ?>">

            <br>

            <div class = firstn > Password:<br> <div>

            <input div class = password type="password" name="password" value="<?php echo $password; ?>">

            <br>
<br>
        

            <input div class = submitbtn  type="submit" value="Update" name="update">
            <a div class ="homebtn" href="home.php">Return to Home</a>
